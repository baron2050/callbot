...
public class AgiOperations implements AgiChannel
{
    ...
    public int asyncStreamFile(String file) throws AgiException
	{
		return getChannel().asyncStreamFile(file);
	}

	public void stopStream() throws AgiException
	{
		getChannel().stopStream();
	}
    ...
    public int getAudioStream(String host, int port) throws AgiException
	{
		return getChannel().getAudioStream(host, port);
	}
    ...
    public int ping() throws AgiException {
    	return getChannel().ping();
	}
}
